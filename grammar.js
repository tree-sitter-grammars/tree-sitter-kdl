  ...
  rules: {
    ...
    document: ($) =>
      field(
        'nodes', seq(
          repeat($.linespace),
          optional(seq($.node, repeat(seq(repeat($.linespace), $.node)))),
          repeat($.linespace),
        ),
      ),
    ...
    linespace: ($) => choice($._newline, $._ws, $.single_line_comment),
